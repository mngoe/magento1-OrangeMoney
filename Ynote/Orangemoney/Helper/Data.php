...
class Ynote_Orangemoney_Helper_Data extends Mage_Core_Helper_Abstract
{
...
//    abstract protected function _getPaymentMeans();
    ...
    {
        return Mage::getUrl('orangemoney/index/cancel');
    }
    ...
    /**
     * Get automatic IPN URL
     *
     * @return string
     */
    public function _getIpnReturnUrl()
    {
	//return 'http://www.visionconfort.com/save-post.php';
        return Mage::getUrl('orangemoney/index/ipn');
    }
